...
const tabs = [
  { id: 'tab1', label: 'Trend Analysis', content: <AllUnit /> },
  { id: 'tab2', label: 'Predictive Insights', content: 'This is your Profile Tab.' },
  { id: 'tab3', label: 'Custom Reports', content: 'Here you can change Settings.' },
...
const AnalysisTabs: React.FC<AnalysisProps> = ({ className }) => {
